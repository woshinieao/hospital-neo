...
static struct sht15_platform_data __sht15_platform_data_1={
		.gpio_data =12,
		.gpio_sck  =11,
		.supply_mv = 5000,
		.checksum = false,
 ...
 static struct sht15_platform_data __sht15_platform_data__2={ 
	 .gpio_data =198,
	 .gpio_sck	=199,
	 .supply_mv = 5000,
	 .checksum = false,
 ...
 static struct platform_device sht10_device_1 = {	 
 	.name = "sht10",   
 	.id = 0, 
 	.dev = {   
 		.platform_data = &__sht15_platform_data_1,   
 		},	 
};


 static struct platform_device sht10_device_2 = {	 
 	.name = "sht10",   
 	.id = 1, 
 	.dev = {   
 		.platform_data = &__sht15_platform_data__2,   
 		},	 
};
...
static int __init sht15_init(void)
{
	int ret;
	int i;
		platform_device_register(&sht10_device_1);
		platform_device_register(&sht10_device_2);
