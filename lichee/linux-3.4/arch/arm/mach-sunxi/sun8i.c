...
//#if defined(CONFIG_SENSORS_SHT15)
static struct sht15_platform_data __sht15_platform_data={
	.gpio_data =12,
	.gpio_sck  =11,
	.supply_mv = 5000,
	.checksum = false,
 ...
 static struct platform_device sht10_device = {	 
 	.name = "sht10",   
 	.id = 0, 
 	.dev = {   
 		.platform_data = &__sht15_platform_data,   
 		},	 
};
...
#endif
	platform_device_register(&sht10_device);
#if defined(CONFIG_SENSORS_INA219)
	/* ina219 use i2c-1 */
